...
if ($api == 'GET') {
    $data = $Libro->fetch($LibroID, $AutorID);
...
if ($api == 'POST') {
    ...
    if ($data !== null) {
        ...
        if ($Autor->insert($Titulo, $AutorID, $EditorialID, $GeneroID, $FechaPublicacion, $ISBN, $Precio, $CantidadStock, $Paginas, $Idioma)) {
            echo $Autor->message('Libro agregado de forma exitosa!', false);
        } else {
            echo $Autor->message('No se pudo agregar el libro!', true);
        }
    } else {
